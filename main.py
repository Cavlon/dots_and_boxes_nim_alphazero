...
config = {
    ...
    "n_games": 500,  # number of games of self-play per iteration (AlphaGo Zero: 25,000)
    ...
    "mcts_parameters": {
        ...
        "temperature_move_threshold": 7,  # number of turns before actions are deterministic (AlphaGo Zero: 30)
        ...
        "dirichlet_alpha": 1.0,  # dirichlet noise: distribution parameter (AlphaGo Zero: 0.03)
    },
    ...
    "optimizer_parameters": {
        "learning_rate": 0.001,  # learning rate for Adam optimizer (AlphaGo Zero: SGD, learning rate scheduling)
...
train_model(config, checkpoint_index)